...
interface EditBrowserVariableModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: () => void;
  isSaving: boolean;
...
const EditBrowserVariableModal: React.FC<EditBrowserVariableModalProps> = ({
  isOpen,
  onClose,
  onSave,
  isSaving,
  ...
  const isSaveDisabled = isSaving || !name.trim() || !value.trim();
...
export default EditBrowserVariableModal;
