...
const CreateCookieModal: React.FC<CreateCookieModalProps> = ({ isOpen, onClose, onSave, isSaving, name, description, value, setName, setDescription, setValue }) => {
        ...
        <div className="cookies-modal-body">
          <label className="cookies-modal-label" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div className="tooltip-container">
              ...
              <div className="tooltip-content">
                The name of the cookie which helps identify the cookie uniquely.
              </div>
            </div>
          </label>
          ...
          <label className="cookies-modal-label" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div className="tooltip-container">
              <span className="tooltip-icon">?</span>
              <div className="tooltip-content">
                Optional description or note about this cookie. This helps provide context for what the cookie is for.
              </div>
            </div>
          </label>
          ...
          <label className="cookies-modal-label" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div className="tooltip-container">
              <span className="tooltip-icon">?</span>
              <div className="tooltip-content">
                Enter the value for the cookie. Please ensure valid JSON syntax.
              </div>
            </div>
          </label>
