...
interface UploadActionDetailProps {
  draft: Action;
...
// Export normalize function for upload action
export const normalizeUploadAction = (source: Action): Action => {
  const cloned: Action = {
    ...source,
  ...
  // For upload action, preserve all action_datas as is (no normalization needed)
  cloned.action_datas = source.action_datas || [];

  return cloned;
};

const UploadActionDetail: React.FC<UploadActionDetailProps> = ({
  draft,
  updateDraft,
  updateField,
  updateElement,
...
export default UploadActionDetail;
