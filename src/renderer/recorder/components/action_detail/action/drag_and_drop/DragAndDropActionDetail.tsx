...
interface DragAndDropActionDetailProps {
  draft: Action;
...
// Export normalize function for drag and drop actions
export const normalizeDragAndDropAction = (source: Action): Action => {
  const cloned: Action = {
    ...source,
  ...
  // For drag and drop actions, preserve all action_datas as is
  cloned.action_datas = source.action_datas || [];

  return cloned;
};

const DragAndDropActionDetail: React.FC<DragAndDropActionDetailProps> = ({
  draft,
  updateDraft,
  updateField,
  updateElement,
...
export default DragAndDropActionDetail;
