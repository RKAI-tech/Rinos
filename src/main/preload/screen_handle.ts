...
export function exposeScreenHandleAPI() {
  contextBridge.exposeInMainWorld("screenHandleAPI", {
    openRecorder: (testcaseId?: string, projectId?: string, testcaseName?: string, browserType?: string) => ipcRenderer.invoke("screen:open_recorder", testcaseId, projectId, testcaseName, browserType),
